...
- [Yul](#yul)
  ...
  - [Работа с памятью](#работа-с-памятью)
    ...
    - [Memory](#memory)
      ...
      - [Массивы фиксированной длины в memory](#массивы-фиксированной-длины-в-memory)
      - [Динамические массивы в memory](#динамические-массивы-в-memory)
      - [Массивы байтов и строки в memory](#массивы-байтов-и-строки-в-memory)
