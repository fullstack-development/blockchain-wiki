...
-   Сохраняется момент неудобства при разработке контрактов, по причине того, что  нужно проверять используемые библиотеки как openzeppelin на использование не работающих precompiled contract;
