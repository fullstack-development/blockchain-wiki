...
Это предложение нацелено на улучшение UX приложений за счет небольших функциональных изменений внутри Ethereum. Решаться могут три основные задачи:
- Батчинг транзакций: Объединение нескольких атомарных операций внутри одной транзакции.
- Безгазовые транзакции или спонсирование: Оплата газа сторонним аккаунтом, возможность оплачивать газ в ERC-20.
